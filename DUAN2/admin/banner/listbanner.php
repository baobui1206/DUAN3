					...
					<table class="portfolio-table">
						<thead class="row-title">
							<tr>
								...
								<th class="tb-col2">Tên banner</th>
								<th class="tb-col2">Ảnh </th>
                                <th class="tb-col2">Link banner </th>
						...
						<tbody>
							...
							foreach ($listbanner as $banner) {
								extract($banner);
								$suabanner = "index.php?act=suabanner&id=" . $id;
								...
								echo '<tr class="row-content">
                                    ...
                                    <td class="tb-col2 col-nameCategory">' . $link . '</td>
									<td class="tb-col3 col-del">
											<div>
											<a href="' . $suabanner . '">Sửa</a>
											</div>
											<div>
											<a href="' . $xoabanner . '">Xóa</a>
											</div>
									</td>';
							}
							?>
