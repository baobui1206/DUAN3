...
<html lang="en">
  <head>
    ...
    <title><?= isset($pageTitle) ? $pageTitle : 'Website của bạn' ?></title>
    <!-- Favicon  -->
    <link
      rel="apple-touch-icon"
      sizes="180x180"
      href="view/asset/images/favicon/apple-touch-icon.png"
    />
    <link
      rel="icon"
      type="image/png"
        ...
        <div class="container">
          <div class="header-child">
            ...
            <div class="header-logo">
              ...
              <!--  -->
              <a href="index.php">
                <img src="view/asset/images/logo/Logo(main) (1).png" alt="" />
              </a>
              <div class="block"></div>
            </div>
            <!-- form -->
    ...
    <div class="container">
        <nav class="header-nav">
          <div class="header-nav__left">
            <div class="category-btn pointer">
              <i class="fa-solid fa-layer-group"></i>
              <span>Danh mục sản phẩm</span>
            </div>
            <div class="category openCategory">
              <!--  -->
             <ul class="category__list height-category">
                <?php
                foreach ($dsdm as $dm) {
                  extract($dm);
          ...
          <div class="header-nav__right">
            <ul class="header-user">
              ...
              <a href="index.php?act=list_yeuthich">
                <li class="header-user__list header-user__loveProduct"><i class="fa-regular fa-heart">
              </i><div class="count-love"><?=$count_yt?></div></li></a>
              <?php endif; ?>
              <a href="index.php?act=viewcart"
                ><li class="header-user__list">
              ...
              <li class="header-user__list header-user__user">
                ...
                <div class="drop-account">
                  ...
                  ?>
                    ...
                    <a href="index.php?act=list_yeuthich">Sản phẩm yêu thích của tôi</a>
                  <?php
                  if ($role == 1) {
                  ?>
